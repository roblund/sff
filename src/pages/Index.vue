<template>
  <Layout>
    ...
    <p>
      ...
      support so kids show up ready to learn each Monday.
    </p>
    ...
    <div>
      ...
      <p>What we are asking:</p>
      <ol>
        <li>
          <strong>Before the Event:</strong> Sign up on the form below to
          register at one of the local grocery stores for a two-hour shift. This
        ...
        <li>
          <strong>The Day of the Event:</strong> Show up at the supermarket
        ...
        <li>
          <strong>After the Event:</strong> As the food drive winds down, a
          truck or van will come to your location to pick up our food bins. The
          final volunteer shift (1:45-3 PM) will be responsible for waiting
          until the truck arrives. We expect all pick-up vehicles to arrive
          before by 3 but, if you are on the last shift, make sure your schedule
      ...
      <p>
        ...
        <a href="https://gallatinvalleyfoodbank.org/give-help/"
          >Gallatin Valley Food Bank's</a
        >
        secure website.
      </p>
    </div>
